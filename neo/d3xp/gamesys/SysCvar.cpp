...
idCVar pm_thirdPersonOffset(		"pm_thirdPersonOffset",		"-25",			CVAR_GAME | CVAR_NETWORKSYNC | CVAR_FLOAT, "left/right offset of thirdperson camera");
...
idCVar pm_autoHop(					"pm_autoHop",				"1",			CVAR_GAME | CVAR_ARCHIVE | CVAR_BOOL, "enable autohop");
